...
knnFit <- caret::train(
    x = training_list$train$x,
    y = training_list$train$y,
    method = "knn",
    trControl = ctrl,
...
plot(diagnostic_svm$model)
plot(diagnostic_knn$model)
plot(diagnostic_rf$model)

plot(diagnostic_svm$fit_cv)
plot(diagnostic_knn$fit_cv)
plot(diagnostic_rf$fit_cv)
