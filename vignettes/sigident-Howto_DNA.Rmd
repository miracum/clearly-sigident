...
```{r}
diagnostic_lasso <- sigident::glmnetSignature_(traininglist = training_list, alpha = 1, nfolds = 10, seed = seed)
sigident::createCVPlot_(cv_obj = diagnostic_lasso$fitCV, filename = paste0(plotdir, "CV_lasso.png"))
sigident::createROCplot_(roc = diagnostic_lasso$roc.min, filename = paste0(plotdir, "ROC_Lasso.min.png"))
sigident::createROCplot_(roc = diagnostic_lasso$roc.1se, filename = paste0(plotdir, "ROC_Lasso.1se.png"))
```

## Elastic net regression 

```{r}
diagnostic_elasticnet <- sigident::glmnetSignature_(traininglist = training_list, alpha = 0.9, nfolds = 10, seed = seed)
sigident::createCVPlot_(cv_obj = diagnostic_lasso$fitCV, filename = paste0(plotdir, "CV_elasticNet.png"))
sigident::createROCplot_(roc = diagnostic_lasso$roc.min, filename = paste0(plotdir, "ROC_elasticNet.min.png"))
sigident::createROCplot_(roc = diagnostic_lasso$roc.1se, filename = paste0(plotdir, "ROC_elasticNet.1se.png"))
```
